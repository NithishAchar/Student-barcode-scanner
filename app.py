...
try:
    ...
    if not os.path.exists(cred_path):
        ...
        print("Creating a sample credentials file for development purposes...")
        
        # Create a sample credentials file for development
        sample_creds = {
            "type": "service_account",
            "project_id": "student-registration-system",
            "private_key_id": "sample-private-key-id",
            "private_key": "-----BEGIN PRIVATE KEY-----\nMIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQC9QFbDLHxZ\n-----END PRIVATE KEY-----\n",
            "client_email": "firebase-adminsdk-sample@student-registration-system.iam.gserviceaccount.com",
            "client_id": "123456789",
            "auth_uri": "https://accounts.google.com/o/oauth2/auth",
            "token_uri": "https://oauth2.googleapis.com/token",
            "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
            "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-sample%40student-registration-system.iam.gserviceaccount.com"
        }
        
        with open(cred_path, 'w') as f:
            json.dump(sample_creds, f, indent=2)
        
        print(f"Sample credentials file created at: {cred_path}")
        print("NOTE: This is a sample file for development only. Replace with real Firebase credentials for production.")
    ...
    print("The application will run in demo mode without database functionality.")
    # Set db to None to indicate it's not available
    db = None
